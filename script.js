...
const whitePawn = './white/pion.jpg';
const wPawn = new Image();
wPawn.src = whitePawn;

const blackPawn = './black/pion.jpg';
const bPawn = new Image();
bPawn.src = blackPawn;

const whiteKnight = './white/kuda.jpg';
const wKnight = new Image();
wKnight.src = whiteKnight;

const blackKnight = './black/kuda.jpg';
const bKnight = new Image();
bKnight.src = blackKnight;

const whiteKing = './white/raja.jpg';
const wKing = new Image();
wKing.src = whiteKing;

const blackKing = './black/raja.jpg';
const bKing = new Image();
bKing.src = blackKing;

const whiteRook = './white/benteng.jpg';
const wRook = new Image();
wRook.src = whiteRook;

const blackRook = './black/benteng.jpg';
const bRook = new Image();
bRook.src = blackRook;

const whiteQueen = './white/mentri.jpg';
const wQueen = new Image();
wQueen.src = whiteQueen;

const blackQueen = './black/mentri.jpg';
const bQueen = new Image();
bQueen.src = blackQueen;

const whiteBishop = './white/seluncur.jpg';
const wBishop = new Image();
wBishop.src = whiteBishop;

const blackBishop = './black/seluncur.jpg';
  ...
  if (!board.pieceSelected) { // true if nothing selected yet
    ...
    if (thisColorsTurn) {
      ...
      if (isLegalMove(currentSquare, thisSquare, board.currentBoard)) {
        ...
        turn = turn == "Giliran Putih" ? "Giliran Hitam" : "Giliran Putih"
